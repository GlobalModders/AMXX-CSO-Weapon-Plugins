...
#define PLUGIN "[CSO] M16A4"
#define VERSION "1.0"
#define AUTHOR "Dias Pendragon"

// Data Config
#define MODEL_V "models/v_m16a4.mdl"
#define MODEL_P "models/p_m16a4.mdl"
#define MODEL_W "models/w_m16a4.mdl"
...
{
	"weapons/m16a4_shoot.wav",
	"weapons/m16a4_boltpull.wav",
	"weapons/m16a4_clipin.wav",
	"weapons/m16a4_clipout.wav"
}

// Weapon Config
#define DAMAGE 27 // 60 for Zombie
...
//new g_Base
new g_Had_Base, g_Clip[33], g_OldWeapon[33], Float:g_Recoil[33][3], g_MyBurst[33], Float:Time[33], g_BurstDone[33]
...
public plugin_init()
{
	...
	// Get
	register_clcmd("say /m16", "Get_Base")
}
...
public client_PostThink(id)
{
	...
	if(get_gametime() - 0.05 > Time[id])
	{
		if(g_MyBurst[id] > 0)
		{
			...
			g_MyBurst[id]--
			if(!g_MyBurst[id]) g_BurstDone[id] = 0
		}
...
public Eject_Shell(id, Shell_ModelIndex, Float:Time) // By Dias
{
